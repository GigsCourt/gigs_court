...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _searchServices(String query) async {
    if (query.trim().isEmpty) {
      ...
      if (_selectedService != null) _clearSelectedService();
      return;
    }
      ...
      if (_selectedService != null) {
        ...
        if (serviceMatch != null) {
          ...
          providersRaw.removeWhere(
              (p) => !(p['serviceIds'] as List<String>).contains(matchId));
        }
      }
            ...
            RefreshIndicator(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  // Selected service chip + verified toggle
                  if (_selectedService != null)
                    Padding(
                  ...
                  if (_isLoading && _allProviders.isEmpty)
                    ...
                    Padding(
                      padding: EdgeInsets.fromLTRB(
                          16.w, _featuredProviders.isEmpty ? 16.h : 0, 16.w, 0),
                      child: Text(
                        _selectedService != null
                            ? 'Results for "$_selectedService"'
                            : 'All Providers',
                        style: AppTextStyles.bodyLarge,
                      ),
                    ),
