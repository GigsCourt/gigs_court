  ...
  Widget build(BuildContext context) {
    if (_currentUser == null) {
      return Scaffold(
        ...
        body: Center(child: Text('Please log in', style: AppTextStyles.bodyMedium)),
      );
    }
    ...
    return Scaffold(
      backgroundColor: AppColors.background,
      appBar: AppBar(
        title: Text('Messages', style: AppTextStyles.headline3),
      ),
      body: Column(
        children: [
          Padding(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return FutureBuilder<DocumentSnapshot>(
                      ...
                      builder: (context, userSnap) {
                        ...
                        final preview = lastMessageType == 'image'
                            ? '📷 Photo'
                        ...
                        return ListTile(
                                ...
                                child: SizedBox(
                                  ...
                                  child: photoUrl != null && photoUrl.toString().isNotEmpty
                                      ...
                                      : Container(
                                          ...
                                          child: Icon(Icons.person, color: AppColors.primary.withValues(alpha: 0.3)),
                                        ),
                                ),
                              ),
                              Positioned(
                          ...
                          subtitle: Text(
                            ...
                            style: AppTextStyles.caption.copyWith(
                              color: isTyping ? AppColors.primary : AppColors.grey,
                            ...
                            children: [
                              ...
                              if (unreadCount > 0) ...[
                                ...
                                Container(
                                  ...
                                  child: Text('$unreadCount', style: TextStyle(color: AppColors.white, fontSize: 11.sp, fontWeight: FontWeight.w600)),
                                ),
                              ],
                            ],
                          ),
