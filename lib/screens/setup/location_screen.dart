    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Could not fetch address. You can type it manually.')),
        );
      }
    }
  }
    ...
    try {
      ...
      if (user != null) {
        await Supabase.instance.client.rpc('upsert_provider_location', params: {
          'p_user_id': user.uid,
          'p_latitude': _pinnedLocation.latitude,
          'p_longitude': _pinnedLocation.longitude,
        ...
        child: Stack(
          children: [
            if (_isMapReady || !_isFetchingLocation)
              GoogleMap(
                initialCameraPosition: CameraPosition(target: _pinnedLocation, zoom: 17),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Getting your location...', style: AppTextStyles.bodyLarge.copyWith(color: AppColors.white)),
                    ],
                  ),
                ),
              ),
                ...
                child: Center(
                  child: Padding(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.location_off, size: 48.sp, color: AppColors.white),
                        SizedBox(height: 16.h),
                        Text(_locationError!, textAlign: TextAlign.center, style: AppTextStyles.bodyLarge.copyWith(color: AppColors.white)),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          decoration: BoxDecoration(color: AppColors.white.withValues(alpha: 0.9), borderRadius: BorderRadius.circular(12.r)),
                          child: Text('Drag map to pin your workspace', style: AppTextStyles.bodySmall.copyWith(fontWeight: FontWeight.w600)),
                        ),
                      ),
                    ],
                  ),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(color: AppColors.primary.withValues(alpha: 0.3), blurRadius: 8.r, offset: Offset(0, 2.h)),
                        ],
                      ),
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(Icons.location_on, size: 18.sp, color: AppColors.white),
                          SizedBox(width: 6.w),
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        SizedBox(height: 16.h, width: 16.w, child: const CircularProgressIndicator(color: AppColors.white, strokeWidth: 2)),
                        SizedBox(width: 8.w),
                        Text('Getting address...', style: AppTextStyles.bodySmall.copyWith(color: AppColors.white)),
                      ],
                    ),
                  ),
                ),
                    ...
                    children: [
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: _address.isNotEmpty ? _address : 'Describe your workspace location...',
                          hintStyle: AppTextStyles.bodyMedium.copyWith(color: AppColors.primary.withValues(alpha: 0.3)),
                          prefixIcon: Icon(Icons.edit_location_outlined, size: 20.sp, color: AppColors.primary.withValues(alpha: 0.5)),
                        ),
                      ),
                      SizedBox(height: 4.h),
                      Text(
                        'Describe your workspace so clients can find you (e.g., "No. 15 Adeola Odeku Street, Victoria Island")',
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: (_address.isNotEmpty && !_isSaving) ? _handleSave : null,
                          child: _isSaving
                      ...
                      SizedBox(height: 6.h),
                      GestureDetector(
                        onTap: () => context.push('/setup/services'),
